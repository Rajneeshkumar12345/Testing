...
//   console.log(uniqueActions, "RRRRRR");
  // Assuming `data` is the object you're working with

  // const uniqueActions = Object.values(data).flat();
  // const permissionObjects = uniqueActions.filter(
  //   (item) => typeof item === "object" && item.action
  // );
  // const actionsArray = permissionObjects.map((perm) => {
  //   return perm.action;
  // });
  // const unique = Array.from(new Set(actionsArray));

  //  console.log("All Actions Array:", actionsArray);

  // const extractedActions = [
  //   ...new Set(
  //     Object.values(data)
  //       .flat()
  //       .filter((item) => typeof item === "object" && item.action)
